...
The user can then modify this using a checkbox.
...
distance.
This *buffer* function does not support the specification of buffer
accuracy (segments / arc vertex distance / maximum deviation), so
this is not available to the user.
